...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["Ruby", "Lua", "PHP", "Python", "Shell", "Perl"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".ijs", &["J"]),
        (".jisonlex", &["Jison Lex"]),
        (".l", &["Common Lisp", "PicoLisp", "Roff", "Lex"]),
        (".rbbas", &["REALbasic"]),
        (".pkgproj", &["XML"]),
        (".scss", &["SCSS"]),
        (".auk", &["Awk"]),
        ...
        (".cls", &["OpenEdge ABL", "Apex", "ObjectScript", "VBA", "TeX"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["IDL", "Proguard", "Prolog", "QMake", "INI"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".doh", &["Stata"]),
        (".ps", &["PostScript"]),
        (".sql", &["TSQL", "SQL", "PLpgSQL", "PLSQL", "SQLPL"]),
        (".txi", &["Texinfo"]),
        (".sma", &["Pawn"]),
        (".wisp", &["wisp"]),
        (".pkb", &["PLSQL"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["HTML", "Pascal", "POV-Ray SDL", "SQL", "NASL", "SourcePawn", "Assembly", "Motorola 68K Assembly", "Pawn", "C++", "PHP"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["MUF", "MATLAB", "M", "Objective-C", "Mercury", "Limbo", "Mathematica"]),
        ...
        (".smali", &["Smali"]),
        (".vht", &["VHDL"]),
        (".sch", &["Scheme", "Eagle", "XML", "KiCad Schematic"]),
        (".sh", &["Shell"]),
        (".kt", &["Kotlin"]),
        (".prisma", &["Prisma"]),
        (".rktd", &["Racket"]),
