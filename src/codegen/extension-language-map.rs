...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["Ruby", "PHP", "Lua", "Perl", "Python", "Shell"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".cls", &["VBA", "TeX", "Apex", "ObjectScript", "OpenEdge ABL"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["Proguard", "QMake", "Prolog", "IDL", "INI"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".doh", &["Stata"]),
        (".ps", &["PostScript"]),
        (".sql", &["SQL", "TSQL", "SQLPL", "PLpgSQL", "PLSQL"]),
        (".txi", &["Texinfo"]),
        (".sma", &["Pawn"]),
        (".wisp", &["wisp"]),
        (".pkb", &["PLSQL"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["SourcePawn", "POV-Ray SDL", "Motorola 68K Assembly", "Pascal", "Pawn", "PHP", "SQL", "C++", "NASL", "Assembly", "HTML"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["Mercury", "Objective-C", "Limbo", "MATLAB", "Mathematica", "M", "MUF"]),
