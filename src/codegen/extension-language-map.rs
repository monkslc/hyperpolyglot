...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["Shell", "Ruby", "Perl", "PHP", "Lua", "Python"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".cls", &["ObjectScript", "TeX", "VBA", "Apex", "OpenEdge ABL"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["IDL", "QMake", "Prolog", "Proguard", "INI"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".doh", &["Stata"]),
        (".ps", &["PostScript"]),
        (".sql", &["PLpgSQL", "PLSQL", "SQL", "TSQL", "SQLPL"]),
        (".txi", &["Texinfo"]),
        (".sma", &["Pawn"]),
        (".wisp", &["wisp"]),
        (".pkb", &["PLSQL"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["Pawn", "HTML", "C++", "Motorola 68K Assembly", "Pascal", "POV-Ray SDL", "SQL", "Assembly", "PHP", "SourcePawn", "NASL"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["Limbo", "MATLAB", "Objective-C", "Mercury", "M", "MUF", "Mathematica"]),
        ...
        (".smali", &["Smali"]),
        (".vht", &["VHDL"]),
        (".sch", &["Scheme", "XML", "Eagle", "KiCad Schematic"]),
        (".sh", &["Shell"]),
        (".kt", &["Kotlin"]),
        (".prisma", &["Prisma"]),
        (".rktd", &["Racket"]),
