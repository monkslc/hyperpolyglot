...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["Lua", "Python", "PHP", "Perl", "Shell", "Ruby"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".cls", &["ObjectScript", "OpenEdge ABL", "TeX", "Apex", "VBA"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["QMake", "Proguard", "IDL", "Prolog", "INI"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".hs-boot", &["Haskell"]),
        (".gpb", &["Gerber Image"]),
        (".mod", &["Linux Kernel Module", "Modula-2", "AMPL", "XML"]),
        (".mao", &["Mako"]),
        (".rex", &["REXX"]),
        ...
        (".doh", &["Stata"]),
        (".ps", &["PostScript"]),
        (".sql", &["PLpgSQL", "TSQL", "SQLPL", "SQL", "PLSQL"]),
        (".txi", &["Texinfo"]),
        (".sma", &["Pawn"]),
        (".wisp", &["wisp"]),
        (".pkb", &["PLSQL"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["SourcePawn", "Motorola 68K Assembly", "HTML", "Assembly", "PHP", "NASL", "SQL", "Pawn", "POV-Ray SDL", "Pascal", "C++"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["Objective-C", "Limbo", "Mercury", "M", "MATLAB", "MUF", "Mathematica"]),
        ...
        (".mll", &["OCaml"]),
        (".q", &["q", "HiveQL"]),
        (".x", &["RPC", "Linker Script", "Logos", "DirectX 3D File"]),
        (".cshtml", &["HTML+Razor"]),
        (".pt", &["XML"]),
        (".dats", &["ATS"]),
        (".numsc", &["NumPy"]),
