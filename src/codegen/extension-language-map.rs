...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["PHP", "Ruby", "Perl", "Lua", "Shell", "Python"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["QMake", "Prolog", "Proguard", "INI", "IDL"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["Motorola 68K Assembly", "PHP", "HTML", "C++", "Pawn", "SourcePawn", "POV-Ray SDL", "NASL", "Pascal", "Assembly", "SQL"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["M", "Mercury", "MUF", "Mathematica", "MATLAB", "Objective-C", "Limbo"]),
