...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["Ruby", "Lua", "PHP", "Shell", "Perl", "Python"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".cls", &["TeX", "OpenEdge ABL", "Apex", "VBA", "ObjectScript"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["Prolog", "QMake", "Proguard", "INI", "IDL"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".hs-boot", &["Haskell"]),
        (".gpb", &["Gerber Image"]),
        (".mod", &["XML", "AMPL", "Modula-2", "Linux Kernel Module"]),
        (".mao", &["Mako"]),
        (".rex", &["REXX"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["Assembly", "SQL", "Pascal", "NASL", "PHP", "Pawn", "HTML", "Motorola 68K Assembly", "SourcePawn", "C++", "POV-Ray SDL"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["Mathematica", "MATLAB", "Limbo", "MUF", "Objective-C", "M", "Mercury"]),
