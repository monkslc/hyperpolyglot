...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["PHP", "Ruby", "Perl", "Python", "Lua", "Shell"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["QMake", "IDL", "INI", "Proguard", "Prolog"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".doh", &["Stata"]),
        (".ps", &["PostScript"]),
        (".sql", &["SQLPL", "TSQL", "SQL", "PLpgSQL", "PLSQL"]),
        (".txi", &["Texinfo"]),
        (".sma", &["Pawn"]),
        (".wisp", &["wisp"]),
        (".pkb", &["PLSQL"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["Pascal", "PHP", "NASL", "SQL", "POV-Ray SDL", "Motorola 68K Assembly", "Assembly", "C++", "SourcePawn", "HTML", "Pawn"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["Limbo", "Mercury", "MUF", "Objective-C", "MATLAB", "M", "Mathematica"]),
        ...
        (".y", &["Yacc"]),
        (".opal", &["Opal"]),
        (".gml", &["XML", "Game Maker Language", "Gerber Image", "Graph Modeling Language"]),
        (".njk", &["HTML+Django"]),
        (".yar", &["YARA"]),
        (".6pl", &["Raku"]),
        (".dwl", &["DataWeave"]),
        ...
        (".mll", &["OCaml"]),
        (".q", &["q", "HiveQL"]),
        (".x", &["Logos", "RPC", "DirectX 3D File", "Linker Script"]),
        (".cshtml", &["HTML+Razor"]),
        (".pt", &["XML"]),
        (".dats", &["ATS"]),
        (".numsc", &["NumPy"]),
