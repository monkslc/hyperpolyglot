...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["Python", "Perl", "Lua", "Ruby", "Shell", "PHP"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".ijs", &["J"]),
        (".jisonlex", &["Jison Lex"]),
        (".l", &["Roff", "Lex", "Common Lisp", "PicoLisp"]),
        (".rbbas", &["REALbasic"]),
        (".pkgproj", &["XML"]),
        (".scss", &["SCSS"]),
        (".auk", &["Awk"]),
        ...
        (".cls", &["Apex", "OpenEdge ABL", "VBA", "ObjectScript", "TeX"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["Proguard", "QMake", "Prolog", "INI", "IDL"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".hs-boot", &["Haskell"]),
        (".gpb", &["Gerber Image"]),
        (".mod", &["Modula-2", "AMPL", "XML", "Linux Kernel Module"]),
        (".mao", &["Mako"]),
        (".rex", &["REXX"]),
        ...
        (".doh", &["Stata"]),
        (".ps", &["PostScript"]),
        (".sql", &["SQLPL", "PLSQL", "PLpgSQL", "SQL", "TSQL"]),
        (".txi", &["Texinfo"]),
        (".sma", &["Pawn"]),
        (".wisp", &["wisp"]),
        (".pkb", &["PLSQL"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["Assembly", "NASL", "POV-Ray SDL", "Motorola 68K Assembly", "HTML", "Pascal", "SourcePawn", "C++", "Pawn", "SQL", "PHP"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["M", "Mathematica", "Objective-C", "Limbo", "MATLAB", "MUF", "Mercury"]),
        ...
        (".smali", &["Smali"]),
        (".vht", &["VHDL"]),
        (".sch", &["XML", "KiCad Schematic", "Scheme", "Eagle"]),
        (".sh", &["Shell"]),
        (".kt", &["Kotlin"]),
        (".prisma", &["Prisma"]),
        (".rktd", &["Racket"]),
