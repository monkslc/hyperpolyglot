...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["Shell", "Ruby", "Python", "PHP", "Lua", "Perl"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".cls", &["VBA", "TeX", "OpenEdge ABL", "ObjectScript", "Apex"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["IDL", "Prolog", "Proguard", "INI", "QMake"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".doh", &["Stata"]),
        (".ps", &["PostScript"]),
        (".sql", &["PLpgSQL", "SQLPL", "SQL", "PLSQL", "TSQL"]),
        (".txi", &["Texinfo"]),
        (".sma", &["Pawn"]),
        (".wisp", &["wisp"]),
        (".pkb", &["PLSQL"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["PHP", "Pawn", "POV-Ray SDL", "NASL", "Assembly", "SourcePawn", "C++", "HTML", "SQL", "Pascal", "Motorola 68K Assembly"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["Limbo", "MUF", "MATLAB", "M", "Objective-C", "Mathematica", "Mercury"]),
        ...
        (".y", &["Yacc"]),
        (".opal", &["Opal"]),
        (".gml", &["Gerber Image", "XML", "Game Maker Language", "Graph Modeling Language"]),
        (".njk", &["HTML+Django"]),
        (".yar", &["YARA"]),
        (".6pl", &["Raku"]),
        (".dwl", &["DataWeave"]),
