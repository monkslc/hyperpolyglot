...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["Ruby", "Perl", "Lua", "PHP", "Shell", "Python"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".cls", &["OpenEdge ABL", "TeX", "Apex", "VBA", "ObjectScript"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["INI", "IDL", "Prolog", "QMake", "Proguard"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["NASL", "C++", "Pascal", "HTML", "POV-Ray SDL", "SQL", "Motorola 68K Assembly", "PHP", "Assembly", "SourcePawn", "Pawn"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["MUF", "M", "Mathematica", "Objective-C", "Mercury", "Limbo", "MATLAB"]),
        ...
        (".mll", &["OCaml"]),
        (".q", &["q", "HiveQL"]),
        (".x", &["Linker Script", "DirectX 3D File", "RPC", "Logos"]),
        (".cshtml", &["HTML+Razor"]),
        (".pt", &["XML"]),
        (".dats", &["ATS"]),
        (".numsc", &["NumPy"]),
        ...
        (".smali", &["Smali"]),
        (".vht", &["VHDL"]),
        (".sch", &["XML", "Eagle", "Scheme", "KiCad Schematic"]),
        (".sh", &["Shell"]),
        (".kt", &["Kotlin"]),
        (".prisma", &["Prisma"]),
        (".rktd", &["Racket"]),
