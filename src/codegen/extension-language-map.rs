...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["Perl", "Ruby", "PHP", "Python", "Shell", "Lua"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".cls", &["ObjectScript", "VBA", "TeX", "OpenEdge ABL", "Apex"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".doh", &["Stata"]),
        (".ps", &["PostScript"]),
        (".sql", &["PLSQL", "SQLPL", "PLpgSQL", "SQL", "TSQL"]),
        (".txi", &["Texinfo"]),
        (".sma", &["Pawn"]),
        (".wisp", &["wisp"]),
        (".pkb", &["PLSQL"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["C++", "NASL", "POV-Ray SDL", "HTML", "Motorola 68K Assembly", "SourcePawn", "Pawn", "Pascal", "PHP", "SQL", "Assembly"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["Objective-C", "Limbo", "MUF", "Mathematica", "M", "Mercury", "MATLAB"]),
        ...
        (".y", &["Yacc"]),
        (".opal", &["Opal"]),
        (".gml", &["Gerber Image", "Graph Modeling Language", "XML", "Game Maker Language"]),
        (".njk", &["HTML+Django"]),
        (".yar", &["YARA"]),
        (".6pl", &["Raku"]),
        (".dwl", &["DataWeave"]),
