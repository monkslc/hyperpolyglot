...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["Lua", "Python", "Perl", "PHP", "Shell", "Ruby"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".ijs", &["J"]),
        (".jisonlex", &["Jison Lex"]),
        (".l", &["Roff", "Lex", "PicoLisp", "Common Lisp"]),
        (".rbbas", &["REALbasic"]),
        (".pkgproj", &["XML"]),
        (".scss", &["SCSS"]),
        (".auk", &["Awk"]),
        ...
        (".cls", &["OpenEdge ABL", "TeX", "Apex", "ObjectScript", "VBA"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["QMake", "IDL", "Prolog", "INI", "Proguard"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".doh", &["Stata"]),
        (".ps", &["PostScript"]),
        (".sql", &["SQLPL", "PLpgSQL", "SQL", "PLSQL", "TSQL"]),
        (".txi", &["Texinfo"]),
        (".sma", &["Pawn"]),
        (".wisp", &["wisp"]),
        (".pkb", &["PLSQL"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["POV-Ray SDL", "Pascal", "NASL", "SQL", "C++", "HTML", "Motorola 68K Assembly", "PHP", "SourcePawn", "Pawn", "Assembly"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["MATLAB", "Mercury", "M", "Limbo", "Mathematica", "Objective-C", "MUF"]),
        ...
        (".smali", &["Smali"]),
        (".vht", &["VHDL"]),
        (".sch", &["Scheme", "KiCad Schematic", "XML", "Eagle"]),
        (".sh", &["Shell"]),
        (".kt", &["Kotlin"]),
        (".prisma", &["Prisma"]),
        (".rktd", &["Racket"]),
