...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".html.hl", &["HTML"]),
        (".g", &["GAP", "G-code"]),
        (".x", &["RPC", "Logos", "Linker Script", "DirectX 3D File"]),
        (".vht", &["VHDL"]),
        (".i7x", &["Inform 7"]),
        (".marko", &["Marko"]),
        (".phtml", &["HTML+PHP"]),
        ...
        (".inc", &["PHP", "Pascal", "SourcePawn", "Assembly", "Motorola 68K Assembly", "C++", "SQL", "Pawn", "POV-Ray SDL", "HTML", "NASL"]),
        ...
        (".tcsh", &["Tcsh"]),
        (".nsi", &["NSIS"]),
        (".sql", &["SQLPL", "SQL", "TSQL", "PLpgSQL", "PLSQL"]),
        (".ronn", &["Markdown"]),
        (".wsdl", &["XML"]),
        ...
        (".vba", &["Vim script", "VBA"]),
        (".idr", &["Idris"]),
        (".m", &["Objective-C", "Mathematica", "MATLAB", "Mercury", "M", "Limbo", "MUF"]),
        (".7", &["Roff Manpage", "Roff"]),
        (".mt", &["Mathematica"]),
        (".shen", &["Shen"]),
        (".ecr", &["HTML+ECR"]),
        ...
        (".db2", &["SQLPL"]),
        (".tfvars", &["HCL"]),
        (".pro", &["IDL", "INI", "Prolog", "QMake", "Proguard"]),
        (".scd", &["SuperCollider"]),
        (".bsl", &["1C Enterprise"]),
        (".self", &["Self"]),
        (".x10", &["X10"]),
        ...
        (".cabal", &["Cabal Config"]),
        (".fcgi", &["PHP", "Ruby", "Python", "Lua", "Perl", "Shell"]),
        (".ring", &["Ring"]),
        (".puml", &["PlantUML"]),
        (".rdoc", &["RDoc"]),
        (".eliom", &["OCaml"]),
