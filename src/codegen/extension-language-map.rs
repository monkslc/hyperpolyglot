...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cr", &["Crystal"]),
        (".rq", &["SPARQL"]),
        (".fcgi", &["Python", "PHP", "Ruby", "Perl", "Shell", "Lua"]),
        (".ipf", &["IGOR Pro"]),
        (".gn", &["GN"]),
        (".vh", &["SystemVerilog"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".ijs", &["J"]),
        (".jisonlex", &["Jison Lex"]),
        (".l", &["Lex", "Roff", "PicoLisp", "Common Lisp"]),
        (".rbbas", &["REALbasic"]),
        (".pkgproj", &["XML"]),
        (".scss", &["SCSS"]),
        (".auk", &["Awk"]),
        ...
        (".cls", &["TeX", "Apex", "ObjectScript", "VBA", "OpenEdge ABL"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["HTML", "PHP", "SQL", "C++", "Motorola 68K Assembly", "SourcePawn", "Pascal", "Pawn", "Assembly", "POV-Ray SDL", "NASL"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["Objective-C", "MATLAB", "Mercury", "M", "Limbo", "Mathematica", "MUF"]),
        ...
        (".y", &["Yacc"]),
        (".opal", &["Opal"]),
        (".gml", &["Gerber Image", "XML", "Graph Modeling Language", "Game Maker Language"]),
        (".njk", &["HTML+Django"]),
        (".yar", &["YARA"]),
        (".6pl", &["Raku"]),
        (".dwl", &["DataWeave"]),
