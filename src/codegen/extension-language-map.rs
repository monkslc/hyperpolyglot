...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        ("rq", &["SPARQL"]),
        ("nim", &["Nim"]),
        ("cls", &["Apex", "OpenEdge ABL", "VBA", "TeX", "ObjectScript"]),
        ("dcl", &["Clean"]),
        ("conllu", &["CoNLL-U"]),
        ...
        ("ch", &["xBase", "Charity"]),
        ("xquery", &["XQuery"]),
        ("x", &["Linker Script", "RPC", "Logos", "DirectX 3D File"]),
        ("fth", &["Forth"]),
        ("ado", &["Stata"]),
        ("apl", &["APL"]),
        ("cginc", &["HLSL"]),
        ...
        ("io", &["Io"]),
        ("ini", &["INI"]),
        ("m", &["Objective-C", "Mathematica", "MATLAB", "Limbo", "MUF", "M", "Mercury"]),
        ("rviz", &["YAML"]),
        ("mrc", &["mIRC Script"]),
        ("storyboard", &["XML"]),
        ...
        ("html", &["HTML"]),
        ("xc", &["XC"]),
        ("fcgi", &["PHP", "Lua", "Perl", "Python", "Shell", "Ruby"]),
        ("xhtml", &["HTML"]),
        ("tml", &["XML"]),
        ("trg", &["PLSQL"]),
        ("qasm", &["OpenQASM"]),
        ...
        ("phtml", &["HTML+PHP"]),
        ("lookml", &["LookML"]),
        ("sql", &["SQLPL", "TSQL", "PLpgSQL", "PLSQL", "SQL"]),
        ("8xk.txt", &["TI Program"]),
        ("fun", &["Standard ML"]),
        ("kid", &["Genshi"]),
        ("eq", &["EQ"]),
        ...
        ("lasso9", &["Lasso"]),
        ("pd", &["Pure Data"]),
        ("inc", &["C++", "Motorola 68K Assembly", "Assembly", "PHP", "HTML", "NASL", "Pawn", "POV-Ray SDL", "Pascal", "SourcePawn", "SQL"]),
        ("groovy", &["Groovy"]),
        ("cc", &["C++"]),
