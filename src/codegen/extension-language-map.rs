...
::phf::Map {
    ...
    entries: ::phf::Slice::Static(&[
        ...
        (".cls", &["ObjectScript", "TeX", "OpenEdge ABL", "VBA", "Apex"]),
        (".workbook", &["Markdown"]),
        (".csproj", &["XML"]),
        (".tcsh", &["Tcsh"]),
        (".sage", &["Sage"]),
        ...
        (".erl", &["Erlang"]),
        (".glf", &["Glyph"]),
        (".pro", &["IDL", "Proguard", "Prolog", "INI", "QMake"]),
        (".mk", &["Makefile"]),
        (".mli", &["OCaml"]),
        (".cobol", &["COBOL"]),
        (".mata", &["Stata"]),
        ...
        (".hs-boot", &["Haskell"]),
        (".gpb", &["Gerber Image"]),
        (".mod", &["Modula-2", "XML", "AMPL", "Linux Kernel Module"]),
        (".mao", &["Mako"]),
        (".rex", &["REXX"]),
        ...
        (".doh", &["Stata"]),
        (".ps", &["PostScript"]),
        (".sql", &["SQL", "PLSQL", "PLpgSQL", "TSQL", "SQLPL"]),
        (".txi", &["Texinfo"]),
        (".sma", &["Pawn"]),
        (".wisp", &["wisp"]),
        (".pkb", &["PLSQL"]),
        ...
        (".boo", &["Boo"]),
        (".sco", &["Csound Score"]),
        (".inc", &["POV-Ray SDL", "Motorola 68K Assembly", "SQL", "NASL", "PHP", "C++", "Pawn", "SourcePawn", "HTML", "Pascal", "Assembly"]),
        (".volt", &["Volt"]),
        (".yrl", &["Erlang"]),
        ...
        (".vw", &["PLSQL"]),
        (".geom", &["GLSL"]),
        (".m", &["Mathematica", "MUF", "Mercury", "MATLAB", "M", "Objective-C", "Limbo"]),
